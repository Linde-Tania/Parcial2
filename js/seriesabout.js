...
fetch(
        `${series_detail_http}${series_id}/credits?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
...
console.log(`${series_detail_http}${series_id}/videos?${api_key}`);
fetch(
        `${series_detail_http}${series_id}/videos?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
...
fetch(
        `${series_detail_http}${series_id}/recommendations?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
